...
const History = () => {
  return (
    <div className="max-w-[1000px] text-sm/6  mx-auto grid gap-y-6 gap grid-cols-2 grid-rows-5 text-grey-font my-10 ps-10 pe-2">
      <div
        className={`relative shadow-lg min-h-[200px] flex items-center py-4 col-start-1 sm:col-start-2 col-end-3 ps-10 md:ps-16 pe-4  bg-lavender-light rounded-r-lg  ${poppins.className}`}
      >
      ...
      <div
        className={`relative shadow-lg min-h-[200px] flex items-center col-start-1 col-end-3 sm:col-end-2 ps-10 md:ps-4 md:pe-16 pe-4 bg-lavender-light rounded-r-lg sm:rounded-r-none sm:rounded-l-lg  ${poppins.className}`}
      >
      ...
      <div
        className={`relative shadow-lg min-h-[200px] flex items-center col-start-1 sm:col-start-2 col-end-3 row-start-3 ps-10 md:ps-16 pe-4 bg-lavender-light rounded-r-lg  ${poppins.className}`}
      >
      ...
      <div
        className={`relative shadow-lg min-h-[200px] flex items-center col-start-1 col-end-3 sm:col-end-2 row-start-4 ps-10 md:ps-4 md:pe-16 pe-4 bg-lavender-light rounded-r-lg sm:rounded-r-none sm:rounded-l-lg  ${poppins.className}`}
      >
      ...
      <div
        className={`relative shadow-lg min-h-[200px] flex items-center col-start-1 sm:col-start-2 col-end-3 row-start-5 ps-10 md:ps-16 pe-4 bg-lavender-light rounded-r-lg  ${poppins.className}`}
      >
        ...
        <Image
          ...
          className="w-[60px] absolute md:w-[100px] -left-8 top-16 md:top-8 md:-left-14 z-20"
        />
          <div className="h-[500px]   w-full absolute z-10 -left-1 bottom-32 border-l-4 border-l-coral "></div>
